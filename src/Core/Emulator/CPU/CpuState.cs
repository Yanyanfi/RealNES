...
internal readonly ref struct CpuState(ref byte a, ref byte x, ref byte y, ref ushort pc, ref byte sp, ref byte p, ref int cycle, ref bool delayI)
{
    ...
    public readonly ref bool DelayI = ref delayI;
}
