...
internal sealed class INC(InstructionServices services) : InstructionBase(services)
{
    public override IReadOnlyList<byte> OpCodes { get; } = [0xe6, 0xf6, 0xee, 0xfe];
    ...
    protected override AddressingType GetAddressingType(byte opCode)
    {
        ...
        {
            0xe6 => AddressingType.ZeroPage,
            0xf6 => AddressingType.ZeroPageX,
            0xee => AddressingType.Absolute,
            0xfe => AddressingType.AbsoluteX,
